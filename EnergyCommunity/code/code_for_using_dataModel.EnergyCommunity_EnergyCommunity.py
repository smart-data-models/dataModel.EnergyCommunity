...
subject = "dataModel.EnergyCommunity"
...
attribute = "regulatoryFramework"
value = regulatoryFramework
# Updates the attribute in the broker; creates the entity if it does not exist
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

hasMember = ['urn:ngsi-ld:EnergyProsumer:prosumer-001', 'urn:ngsi-ld:EnergyProsumer:prosumer-002']
attribute = "hasMember"
value = hasMember
# Updates the attribute in the broker; creates the entity if it does not exist
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
